...
export const Hutulbur = () => {
  return (
    <div className="h-[188px] w-[514px] ml-[40px] rounded-[22px] shadow-md grid grid-rows-4  smmsm:w-[414px]">
      <img
        className="h-[162px] w-[225px] mt-[1vh] ml-[11px] bg-current rounded-lg rounded-[22px] bg-repeat  smmsm:w-[125px]"
        src={Img2}
        alt="img2"
      />

      <div className="w-[257px] ml-[361px] mt-[-20px]  smmsm:ml-[261px]">
        <p className="ml-[-105px] font-Poppins font-bold text-[19.2px] text-DarkText  smmsm:text-[18px] smmsm:w-[220px]">
          Taman Nasional Bunaken
        </p>
        <p className="ml-[-105px] font-Poppins font-normal text-[18px] w-[255px] mt-[3px] smmsm:text-[16px] smmsm:w-[220px] smmsm:my-[10px]">
