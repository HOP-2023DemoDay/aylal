    ...
    <div className="overflow-hidden w-screen  ">
      <div className="flex felx-col w-full h-52 bg-slate-500 w-full">
        <button
          ...
          className="h-10 mt-[3vh] ml-[2vw]"
        >
          {" "}
          <img src={Arrow} alt="" />
        </button>
        <div className="font-bold text-[33.18px] mb-[2vh] text-white flex items-end smmsm:text-[25px]">
      ...
      <div className="w-screen flex flex-row justify-around smmsm:flex-col">
        ...
        <div className="flex flex-col m-6  w-1/3 smmsm:w-[380px]  ">
          <div className=" smmsm:mt-[-95vh]">
            <img
              src={Map}
              className="w-full h-[46vh] bg-slate-900 md:h-[34vh] md: w-[40vh]"
              alt="Map"
            />
          ...
          <div className="flex flex-col justify-center w-[650px] xl:mt-[8vh] smmsm:mt-[30vh]">
            <div className="flex flex-row">
              ...
              <button className="text-Button ml-[10vw] smmsm: ml-[30vw]">
                see all
              </button>
            </div>
            <News />
