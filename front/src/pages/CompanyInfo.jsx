  ...
  return (
    <div>
      ...
      <div className="mt-[16vh] w-[80vw] ml-[10vw] text-center flex justify-between ">
        ...
        <div>
          <div className="w-[29vw] h-[46vh] bg-slate-900 "></div>
          <div className="w-[26vw] ml-[2vw] mt-[2vh] flex flex-wrap">
            <p>Address:</p>
            <input className="ml-[1vw] drop-shadow-md" type="text" placeholder="njfkbjsbrz" />
            <p className="ml-[1vw]">Email:</p>
            <input className="ml-[1vw] drop-shadow-md" type="text" placeholder="email"/>
            <p className="mt-[2vh]">Phone:</p>
            <input className="mt-[2vh] ml-[1vw] drop-shadow-md" type="text" placeholder="+12345678" />
          </div>
        </div>
      </div>
